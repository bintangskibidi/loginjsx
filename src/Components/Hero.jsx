...
const headphoneData = [
  {
    ...
    title: "Orange Fanta",
    subtitle:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit.   minima ad ut id eos iusto minima ad ut id eos ad ut id eos",
    price: "$40",
    modal: "Orange",
    bgColor: "#cf4f00",
  },
            ...
            <div className="space-y-5 text-center md:text-left">
              ...
              >
                {headphoneData.map((item) => {
                  return (
                    <UpdateFollower
    key={item.id} // Tambahkan prop key di sini
    mouseOptions={{
